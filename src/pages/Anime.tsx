...
const PLOT = [
  {
    ...
    color: "#ef4444",
    icon: "CloudRain",
    text: "Артём — 23 года, парень из Екатеринбурга, работает на трёх работах. Его младшая сестра Настя после аварии прикована к инвалидному креслу, а бабушка, которая их вырастила, тяжело больна и нуждается в дорогой операции. Денег катастрофически не хватает, долги по кредитам растут, отчаяние сжимает горло.",
  },
  {
    act: "Акт 2 — Искра",
    color: "#eab308",
    icon: "Sparkles",
    text: "Случайно Артём находит российскую платформу FLOWERFLIP. Сначала просто перепродаёт остатки букетов из соседнего цветочного через аукцион. Первая прибыль — копейки, но это работает. Он изучает рынок, ловит сезонные пики — 14 февраля, 8 марта, выпускные, — выстраивает рейтинг и репутацию надёжного продавца.",
  },
  {
    act: "Акт 3 — Взлёт",
    color: "#06d6de",
    icon: "TrendingUp",
    text: "Артём превращает хобби в систему: договаривается с флористами, event-агентствами, свадебными салонами, выкупает неликвид и перепродаёт через ставки. Внутренний кошелёк растёт. Он нанимает курьеров, выходит из Екатеринбурга в Москву, Питер, Казань. Из выживающего парня он становится предпринимателем.",
  },
  {
    act: "Акт 4 — Спасение",
    color: "#22c55e",
    icon: "Heart",
    text: "На заработанные деньги Артём оплачивает операцию бабушки и реабилитацию сестры. Настя встаёт на ноги после курса лечения. Финал: семья вместе в своём цветочном магазине, который теперь и продаёт, и выставляет лоты на платформе. «Цветы умирают за три дня. Мечты — нет».",
  },
];

const CHARACTERS = [
  { name: "Артём", role: "Главный герой", desc: "Упорный, добрый, не сдаётся ради семьи", emoji: "🧑‍💼", color: "#ff3d8b" },
  { name: "Настя", role: "Сестра", desc: "В инвалидном кресле, мечтает снова рисовать", emoji: "👧", color: "#a855f7" },
  { name: "Бабушка Зоя", role: "Опора семьи", desc: "Больна, вырастила внуков одна", emoji: "👵", color: "#06d6de" },
  { name: "Марина", role: "Флорист-наставница", desc: "Учит Артёма искусству букетов и торга", emoji: "💐", color: "#22c55e" },
];
